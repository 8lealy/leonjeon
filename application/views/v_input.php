...
<header id="header" class="header-tops">
	...
	<div class="container">
		<div class="column">
			...
			<center>
		<h2>SILAHKAN ISI FORM BERIKUT UNTUK MENAMBAHKAN DATA</h2>
	</center>
	<form action="<?php echo base_url().'crud/tambah_aksi'; ?>" method="post">
		...
		<tr>
			...
			<td>:</td>
			<td>
				<input type="radio" name="jam" value="07AM-09AM" required="yes"><label for="07AM-09AM"> 07AM-09AM</label>
		...
		<tr>
			...
			<td></td>
			<td>
				<input class="btn btn-outline-light" type="submit" value="TAMBAH">
			</td>
		</tr>
	</table>
	</form>	
